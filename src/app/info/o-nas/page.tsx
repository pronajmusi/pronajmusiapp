        ...
        <main className="flex min-h-screen justify-start items-center w-full my-10 py-24 px-12 flex-col">
            <div className="w-11/12 md:w-10/12 flex flex-col">
                <div className="mb-4 flex flex-col">
                    ...
                    <p className="mt-5 text-slate-500">O Nás - PronajmuSi.cz: Spolehlivé Propojení Pro Snadné Pronájmy</p>
                </div>
                <div className="mt-10">
                ...
                <div className="mt-10">
                    <h2 className="mb-4 text-2xl font-semibold">Naše Vize</h2>
                    <p className="text-slate-500">
                ...
                <div className="mt-10">
                    <h2 className="mb-4 text-2xl font-semibold">Jak To Funguje</h2>
                    <p className="text-slate-500">
                ...
                <div className="mt-10">
                    <h2 className="mb-4 text-2xl font-semibold">Proč Vybrat PronajmuSi.cz</h2>
                    <p className="text-slate-500">
