    ...
    return (
        <main className="flex min-h-screen justify-start items-center w-full my-10 py-24 px-12 flex-col">
            ...
            <div className="mb-4 flex flex-col">
                ...
                <p className="mt-5 text-slate-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur nostrum inventore, corporis voluptates vitae nesciunt qui aut omnis placeat quae libero sapiente esse! Molestias est error ducimus culpa officiis repellat.</p>
            </div>
            <div className="mt-10">
