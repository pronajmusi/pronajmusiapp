        ...
        <main className="flex min-h-screen justify-start items-center w-full my-10 py-24 px-12 flex-col">
            <div className="w-11/12 md:w-10/12 flex flex-col">
                <div className="mb-4 flex flex-col">
                    <h1 className="font-semibold text-5xl">O nás</h1>
                ...
                <div className="my-10">
                    <h2 className="mb-8 text-4xl font-semibold">Naše Vize</h2>
                    <p className="text-slate-500 px-2">
                ...
                <div className="my-10">
                    <h2 className="mb-8 text-4xl font-semibold">Jak To Funguje</h2>
                    <p className="text-slate-500 px-2">
                ...
                <div className="my-10">
                    <h2 className="mb-8 text-4xl font-semibold">Proč Vybrat PronajmuSi.cz</h2>
                    <p className="text-slate-500 px-2">
