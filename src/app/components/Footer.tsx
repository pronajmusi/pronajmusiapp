...
export default function Footer(){
    return (
        <div className="bg-white px-8 py-12 flex flex-col md:flex-row justify-center shadow border-t border-t-gray-200">
            <div className="flex items-center">
                <Image alt="Hlavní logo" src={MainLogoSrc} width={30} height={30}/>
                <span className="text-2xl font-bold ml-2">PronajmuSi</span>
            </div>
            <div className="flex flex-col align-top list-none md:ml-12">
            ...
            <div className="flex flex-col justify-start list-none md:ml-4">
                <li className="hover:underline">
